...
\paragraph{Trading off time.}
On the NER task, we find that LENSE produces more accurate results than the entropic threshold baseline despite querying for fewer labels. It does so by recognizing that, in some situations, waiting for the response of a query can allow it to do better\reword.
