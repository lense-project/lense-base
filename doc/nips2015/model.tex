...
\begin{figure}
  \begin{centering}
    \begin{subfigure}[b]{0.58\textwidth}
      ...
      \caption{
      Two possible timelines of queries and responses.
      ...
      See \sectionref{behavior} for a description of how the agent reasons about these two events.
      }
    \end{subfigure}
    \hfill
...
For notational simplicity, let $r_j = \emptyset$ and $t_j = \emptyset$ iff the responses for the query $q_j$ have not been received by time $\now$.
