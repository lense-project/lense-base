...
In this paper, we propose a new framework called \emph{on-the-job learning} (formalizing and generalizing ideas first implemented in \citep{lasecki2013real}), in which we smoothly transition a \emph{live} system from pure crowdsourcing toward, in the limit, unassisted AI.
