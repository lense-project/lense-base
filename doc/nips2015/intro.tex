...
We focus on structured classification problems using conditional exponential families, a general model class that has been used to \todo{citefest}.
...
We significantly outperform the baseline of asking crowdworkers for labels for each example, as well as the system trained on fully labeled past data.
We are comparable with state of the art-ish with a handful of the training labels.
