...
On the NER task we obtained a 6--7 fold reduction compared to full human annotation with no drop in accuracy,
and a 28 F$_1$ accuracy improvement over standard active learning.
