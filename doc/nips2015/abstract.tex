...
datasets---named-entity recognition, sentiment classification, and image classification. On the NER task we obtained a 10 fold reduction in cost compared to full
human annotation. We also achieve a $8\%$ \fone{} improvement over having a single
