...
We obtained a 6--7 fold reduction compared to full human annotation with no drop in accuracy,
and a XXX accuracy improvement over standard active learning.
