...
\afterpage{\noindent\begin{figure}
  \begin{centering}
    \begin{subfigure}[b]{0.58\textwidth}
      ...
      \caption{On-the-job classification's behavior over time}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.38\textwidth}
      \includegraphics[width=\textwidth,height=0.23\textheight,keepaspectratio]{figures/single-move.pdf}
      \caption{Single-query gametree}
    \end{subfigure}
  \end{centering}
\label{fig:piano-roll}
\caption{Visualizing the on-the-job setting for classifying ``Soup on George str.''}
\end{figure}}
