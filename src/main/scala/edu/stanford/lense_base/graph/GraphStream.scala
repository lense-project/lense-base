...
class GraphStream {
  ...
  private def learnFullyObserved(graphs : Iterable[Graph]): Unit = {
    ...
    val trainer = new BatchTrainer(model.parameters, new LBFGS() with L2Regularization{variance = 1}, maxIterations = 10)
